...
{
	tfn_block_inv_cac.id = GEM_LILAC_ID;
...
* 8		ash npc 1
*/
char (*tilefn[])(m_tilefn* t) = { &tfn_dm_init_npc, &tfn_park_loadcheck0, &tfn_park_exit, &tfn_ennpc_init, &tfn_block_inv_0, &tfn_rand_disp_cache, &tfn_ash_ennpc0, &tfn_debug, &tfn_ash_ennpc1, };