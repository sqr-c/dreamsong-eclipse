...
#define SPRITE_MARKER_OFFSET (SPRITE_OFFSET - 21)
...
void joinmv();
void joinmv_f();
void adjustmap(char* deltaf, long adj, int* dv, float* sv, int offs, int dir);
...
unsigned short (*rar_fn[])(short, int, int);
