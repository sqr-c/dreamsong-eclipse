...
#define NUM_SPRITE	(315)

#define TERM_MENU_MAX	7

#define SPRITE_CHAR_OFFSET		(0)
#define SPRITE_TEXT_OFFSET		(14)
#define SPRITE_BORD_OFFSET		(139)
#define SPRITE_FLAT_OFFSET		(SPRITE_BORD_OFFSET+(6*2)+1)
#define SPRITE_ELEM_OFFSET		(154)
#define SPRITE_TILE_OFFSET		(204)
#define SPRITE_FX_OFFSET		(303)
#define SPRITE_MAT_OFFSET		(274)

#define TILE_DIVE_ID	(SPRITE_TILE_OFFSET + 69)
#define TILE_SHINY_ID	(SPRITE_FX_OFFSET + 0)

#define BORD_SIZE	16
#define TEXT_WIDTH	16
#define TEXT_HEIGHT	16
#define TEXT_X (SPRITE_TEXT_OFFSET + 10)
#define TEXT_0 (SPRITE_TEXT_OFFSET + 53)
#define TEXT_SPACE_INDEX	SPRITE_TEXT_OFFSET
#define CHARSET_LENGTH	125
#define CHARSET_END	(SPRITE_TEXT_OFFSET + CHARSET_LENGTH - 1)

#define SPRITE_TARGET_OFFSET	(SPRITE_TILE_OFFSET + 20)
...
extern icac_itemcache_min trade_in_cache;
extern icac_itemcache_min trade_out_cache;
...
extern dm_tablef_a dmtable;

int lifec(ch_char* c);

#define RAR_FN0_ADJ_DEF ((float)65536)	//PRE:	(pow(2, 16))
