...
{
	SPRITE_MAT_OFFSET + 0, SPRITE_MAT_OFFSET + 1, SPRITE_MAT_OFFSET + 2, SPRITE_MAT_OFFSET + 3,
	SPRITE_MAT_OFFSET + 4, SPRITE_MAT_OFFSET + 5, SPRITE_MAT_OFFSET + 6, SPRITE_MAT_OFFSET + 7,
	SPRITE_MAT_OFFSET + 8, SPRITE_MAT_OFFSET + 9, SPRITE_MAT_OFFSET + 10, SPRITE_MAT_OFFSET + 11,
	SPRITE_MAT_OFFSET + 12, SPRITE_MAT_OFFSET + 13, SPRITE_MAT_OFFSET + 14, SPRITE_MAT_OFFSET + 15,
	SPRITE_MAT_OFFSET + 16, SPRITE_MAT_OFFSET + 17, SPRITE_MAT_OFFSET + 18, SPRITE_MAT_OFFSET + 19,
	SPRITE_MAT_OFFSET + 20, SPRITE_MAT_OFFSET + 21, SPRITE_MAT_OFFSET + 22, SPRITE_MAT_OFFSET + 23,
	SPRITE_MAT_OFFSET + 24, SPRITE_MAT_OFFSET + 25, SPRITE_MAT_OFFSET + 26, SPRITE_MAT_OFFSET + 27,
	SPRITE_MAT_OFFSET + 28,
};
...
char um_newmap_init_texts()
{
	...
	gtexta[TEXT_UM_NEWMAP_NAME_IDX].size = 0;
...
void um_map_save()
{
	char filetemp[] = "XXXX.smd";
	char file[(sizeof(path_userdir_dynamic) - 1) + (sizeof(filetemp) - 1) + 1];
	sprintf(file, "%s%s", path_userdir_dynamic, filetemp);

	const char* sbuf = &um_name_text[UM_MAX_MAP_NAME_TEXT_SIZE * um_map_index];
	fnv1a_hash_str(sbuf, strlen(sbuf), &file[strlen(file) - (sizeof(filetemp) - 1)]);
	...
	{
		ch.sprite.x = um_pre_ch_x;
		ch.sprite.y = um_pre_ch_y;
		writesed(PATH_SED);
		ch.sprite.x = ch.dx;
		ch.sprite.y = ch.dy;
	}
